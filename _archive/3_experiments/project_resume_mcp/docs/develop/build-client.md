...
Before you begin, it helps to have gone through our [Build an MCP Server](build-server.md) tutorial so you can understand how clients and servers communicate.
