...
## SKILLS
*   **Languages & Frameworks:** Python (Flask, FastAPI), Node.js, React, TypeScript, Kotlin, C#, JavaScript
*   **Developer Tools & Version Control:** Git, Docker, Cursor, Windsurf, Linear, Playwright, Unity3D, n8n, Jira
...
*   Developed innovative software tools including Project Scott, an AI-powered documentation assistant that provided instant answers to developer questions, located relevant code and pipeline documentation, and integrated with issue tracking systems. Improved question resolution time by 82%, with projected savings of 240+ dev-hrs/month through workflow customization and third-party system integration.
...
*   Developed and maintained developer tools to assist in software development, creating automated onboarding systems that reduced setup time by 75% and saved 3,528 dev-hrs/year while eliminating setup-related errors through testing automation frameworks.
...
*   Led static analysis customization through organization-wide CodeGuru Profiler adoption across 7 projects, integrating static analysis tools with existing workflows and reducing on-call incidents & maintenance hours.
...
*   Developed code generation and parsing tools using Python scripts to automate extraction of 10 years of Git version history from 15 applications, utilizing regular expressions and formal text parsing to save 7 dev-hrs/week.
